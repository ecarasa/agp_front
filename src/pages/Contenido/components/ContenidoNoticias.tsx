...
const ContenidoNoticias = () => {
    ...
    const getSeccion = () => {
        ...
        return filterByKey(secciones, SeccionesEnum.NOTICIAS, 'seccion')[0] || secciones[3];
    };
            ...
            {showDetail && selectedItem ? (
                ...
                <>
                    {updatingContent ? (
                        ...
                        >
                            <SectionHeader>
                                <SectionHeader.DrawerTitle> {t('news')}</SectionHeader.DrawerTitle>
                            </SectionHeader>
                            {step === 0 && (
                                ...
                                >
                                    <Grid item xs={12}>
                                        ...
                                        >
                                            ...
                                            <PublishBtn
                                                key='publish-btn-noticias'
                                                captionOn={t('publish')}
                                                captionOff={t('publishing')}
                                                publishingContent={false}
                                                publishContent={() => onPublishClick(IdSeccionesEnum.ID_SECCION_NOTICIAS)}
                                            />
                                        </Grid>
                                    </Grid>
                                    <Grid item xs={12}>
