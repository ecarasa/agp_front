import ConversationDetailDrawer from '../../Giros/components/ConversationDetailDrawer';
...
function HistoryPatentConversation(props: any) {
    const {
        onClose,
        historyConversation,
            ...
            <Card variant="outlined" sx={{ height: 'inherit' }}>
                <CardContent>
                    ...
                    <Box className={styles['section-title']}>
                        ...
                        {!fetchingHistoryConversation && !!access?.[8]?.[36] && (
                            <Button
                                type="outlined"
                                onClick={() => navigate(`/agp/patentes/${selected?.id}/detalle`)}
                            >
                                Detalle de Patente
                            </Button>
                        )}
...
export default HistoryPatentConversation;
